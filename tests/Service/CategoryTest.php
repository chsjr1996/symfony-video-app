...
class CategoryTest extends KernelTestCase
{
    ...
    {
        yield [
            '<ul><li><a href="/en/video-list/category/computers,6">Computers</a><ul><li><a href="/en/video-list/category/laptops,8">Laptops</a><ul><li><a href="/en/video-list/category/hp,14">HP</a></li></ul></li></ul></li></ul>',
            [
    ...
    {
        yield [
            '<ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i> Toys <a href="/en/admin/su/categories/edit/2">Edit</a><form class="delete-form" action="/en/admin/su/categories/2" method="POST"><input type="hidden" name="_method" value="DELETE" /> <input type="submit" value="Delete" onclick="return confirm(\'Are you sure?\');" /></form></li></ul>',
            [
        ...
        yield [
            '<ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i> Toys <a href="/en/admin/su/categories/edit/2">Edit</a><form class="delete-form" action="/en/admin/su/categories/2" method="POST"><input type="hidden" name="_method" value="DELETE" /> <input type="submit" value="Delete" onclick="return confirm(\'Are you sure?\');" /></form></li><li><i class="fa-li fa fa-arrow-right"></i> Movies <a href="/en/admin/su/categories/edit/3">Edit</a><form class="delete-form" action="/en/admin/su/categories/3" method="POST"><input type="hidden" name="_method" value="DELETE" /> <input type="submit" value="Delete" onclick="return confirm(\'Are you sure?\');" /></form><ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i> Horrors <a href="/en/admin/su/categories/edit/4">Edit</a><form class="delete-form" action="/en/admin/su/categories/4" method="POST"><input type="hidden" name="_method" value="DELETE" /> <input type="submit" value="Delete" onclick="return confirm(\'Are you sure?\');" /></form><ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i> Not so scary <a href="/en/admin/su/categories/edit/5">Edit</a><form class="delete-form" action="/en/admin/su/categories/5" method="POST"><input type="hidden" name="_method" value="DELETE" /> <input type="submit" value="Delete" onclick="return confirm(\'Are you sure?\');" /></form></li></ul></li></ul></li></ul>',
